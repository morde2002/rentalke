...
export default function PropertyDetailPage({
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        {/* Back Button */}
        <section className="bg-white border-b border-border-gray py-4">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="mb-8">
                {property.images.length > 0 ? (
                  <div className="relative aspect-[16/9] bg-bg-light rounded-button overflow-hidden">
                    <Image
                    ...
                    {property.available ? (
                      <>
                        ...
                        {property.whatsapp_number && (
                          <a
                            href={`https://wa.me/${property.whatsapp_number}?text=Hi, I'm interested in the ${property.type} in ${property.neighborhood} for Ksh ${property.price.toLocaleString()}/month. Can I schedule a viewing?`}
                            target="_blank"
