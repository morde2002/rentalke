...
export const metadata: Metadata = {
  ...
  description: "RentalKE Terms of Service. Read our terms and conditions for using our rental property platform in Kenya. Understand your rights and responsibilities as a user.",
  robots: {
    index: true,
    follow: true,
  },
